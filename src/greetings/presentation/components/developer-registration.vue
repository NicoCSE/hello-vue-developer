...
const emit= defineEmits(['developer-registrered','registration-deferred']);
...
function submitRegistrationRequest(){
  ...
  if(submittedFirstName || submittedLastName){
    ...
    errorMessage.value='Please provide at least first name or last name. Warning: Both are required fpr a successful registration.';
  }
}
